...
def test_get_path_weights_sh(tmp_path: pathlib.PosixPath) -> None:
    ...
    have order parameter 1.25 x 2 and 1.3 x 8, so we should get 80% *cross* 1.25
    and 0% *cross* 1.3. The interfaces are [1.0, 2.0], so the pcross should read
    ...
    expected_pcross = [[1.0, 1.0],[1.25, 0.8],[1.30, 0.0]]
